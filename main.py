...
baseline = ReactiveBaseline(l = L)

agent = Agent(input_dim, HIDDEN_DIM, emb_dim, DROPOUT_RATE, LSTM_LAYER, num_entity, num_rel,num_subgraph, GAMMA, LR, model_param_list, baseline, device)
# training loop
